...
public class AttendanceController {
    ...
    @GetMapping("/me")
    public ApiResponse<AttendanceSummaryResponse> getMySummary(@AuthenticationPrincipal String username) {
        return ApiResponse.ok(attendanceService.getMySummary(username));
    }
}
