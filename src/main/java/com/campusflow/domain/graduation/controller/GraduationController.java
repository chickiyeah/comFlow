...
public class GraduationController {
    ...
    @GetMapping("/check")
    public ApiResponse<GraduationCheckResponse> checkGraduation(@AuthenticationPrincipal String username) {
        return ApiResponse.ok(graduationService.checkGraduation(username));
    }
}
